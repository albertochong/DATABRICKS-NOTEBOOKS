...
# MAGIC     var allHints = document.getElementsByClassName("hint-1660");
# MAGIC     var answer = document.getElementById("answer-1660");
...
# MAGIC     }
# MAGIC 
# MAGIC     var button = document.getElementById("hint-button-1660");
...
# MAGIC           id="hint-button-1660">Click here for a hint</button>
# MAGIC </div>
# MAGIC <div id="answer-1660" style="padding-bottom: 20px; display: none">
# MAGIC   The answer:
