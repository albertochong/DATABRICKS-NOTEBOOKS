...
# MAGIC     var allHints = document.getElementsByClassName("hint-3957");
# MAGIC     var answer = document.getElementById("answer-3957");
...
# MAGIC     }
# MAGIC 
# MAGIC     var button = document.getElementById("hint-button-3957");
...
# MAGIC           id="hint-button-3957">Click here for a hint</button>
# MAGIC </div>
# MAGIC <div id="answer-3957" style="padding-bottom: 20px; display: none">
# MAGIC   The answer:
...
# MAGIC <script type="text/javascript">
# MAGIC   window.onload = function() {
# MAGIC     var allHints = document.getElementsByClassName("hint-4802");
# MAGIC     var answer = document.getElementById("answer-4802");
# MAGIC     var totalHints = allHints.length;
# MAGIC     var nextHint = 0;
# MAGIC     var hasAnswer = (answer != null);
# MAGIC     var items = new Array();
...
# MAGIC     }
# MAGIC 
# MAGIC     var button = document.getElementById("hint-button-4802");
# MAGIC     if (totalHints == 0) {
# MAGIC       button.innerHTML = answerLabel;
# MAGIC     }
# MAGIC     button.onclick = function() {
...
# MAGIC   <button type="button" class="btn btn-light"
# MAGIC           style="margin-top: 1em"
# MAGIC           id="hint-button-4802">Click here for a hint</button>
# MAGIC </div>
# MAGIC <div id="answer-4802" style="padding-bottom: 20px; display: none">
# MAGIC   The answer:
# MAGIC   <div class="answer" style="margin-left: 1em">
...
# MAGIC <script type="text/javascript">
# MAGIC   window.onload = function() {
# MAGIC     var allHints = document.getElementsByClassName("hint-5784");
# MAGIC     var answer = document.getElementById("answer-5784");
# MAGIC     var totalHints = allHints.length;
# MAGIC     var nextHint = 0;
# MAGIC     var hasAnswer = (answer != null);
# MAGIC     var items = new Array();
...
# MAGIC     }
# MAGIC 
# MAGIC     var button = document.getElementById("hint-button-5784");
# MAGIC     if (totalHints == 0) {
# MAGIC       button.innerHTML = answerLabel;
# MAGIC     }
# MAGIC     button.onclick = function() {
...
# MAGIC   <button type="button" class="btn btn-light"
# MAGIC           style="margin-top: 1em"
# MAGIC           id="hint-button-5784">Click here for a hint</button>
# MAGIC </div>
# MAGIC <div id="answer-5784" style="padding-bottom: 20px; display: none">
# MAGIC   The answer:
# MAGIC   <div class="answer" style="margin-left: 1em">
...
# MAGIC <script type="text/javascript">
# MAGIC   window.onload = function() {
# MAGIC     var allHints = document.getElementsByClassName("hint-5938");
# MAGIC     var answer = document.getElementById("answer-5938");
# MAGIC     var totalHints = allHints.length;
# MAGIC     var nextHint = 0;
# MAGIC     var hasAnswer = (answer != null);
# MAGIC     var items = new Array();
...
# MAGIC     }
# MAGIC 
# MAGIC     var button = document.getElementById("hint-button-5938");
# MAGIC     if (totalHints == 0) {
# MAGIC       button.innerHTML = answerLabel;
# MAGIC     }
# MAGIC     button.onclick = function() {
...
# MAGIC   <button type="button" class="btn btn-light"
# MAGIC           style="margin-top: 1em"
# MAGIC           id="hint-button-5938">Click here for a hint</button>
# MAGIC </div>
# MAGIC <div id="answer-5938" style="padding-bottom: 20px; display: none">
# MAGIC   The answer:
# MAGIC   <div class="answer" style="margin-left: 1em">
...
# MAGIC <script type="text/javascript">
# MAGIC   window.onload = function() {
# MAGIC     var allHints = document.getElementsByClassName("hint-8900");
# MAGIC     var answer = document.getElementById("answer-8900");
# MAGIC     var totalHints = allHints.length;
# MAGIC     var nextHint = 0;
# MAGIC     var hasAnswer = (answer != null);
# MAGIC     var items = new Array();
...
# MAGIC     }
# MAGIC 
# MAGIC     var button = document.getElementById("hint-button-8900");
# MAGIC     if (totalHints == 0) {
# MAGIC       button.innerHTML = answerLabel;
# MAGIC     }
# MAGIC     button.onclick = function() {
...
# MAGIC   <button type="button" class="btn btn-light"
# MAGIC           style="margin-top: 1em"
# MAGIC           id="hint-button-8900">Click here for a hint</button>
# MAGIC </div>
# MAGIC <div id="answer-8900" style="padding-bottom: 20px; display: none">
# MAGIC   The answer:
# MAGIC   <div class="answer" style="margin-left: 1em">
