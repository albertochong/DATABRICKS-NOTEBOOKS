...
class DummyData(val tableName: String, val databaseName:String = null, val seed: String = null, val numRows: Int = 300) {
  ...
  private var dbName = if (databaseName == null) username else databaseName
