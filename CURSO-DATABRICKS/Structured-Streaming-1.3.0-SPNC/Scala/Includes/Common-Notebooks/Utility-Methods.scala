...
// MAGIC  
// MAGIC displayHTML(s"""
// MAGIC Defining lesson-specific utility methods...
// MAGIC <ul>
// MAGIC   <li><span style="color: #339966; font-weight:bold">untilStreamIsReady(name)</span>: Utility method to block execution until the stream is fully initialized.</li>
// MAGIC   <li><span style="color: #339966; font-weight:bold">stopAllStreams()</span>: Utility method to stop all active streams in a fail-safe manner.</li>
// MAGIC </ul>
// MAGIC """
// MAGIC )
