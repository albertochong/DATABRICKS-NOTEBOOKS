...
// MAGIC     var allHints = document.getElementsByClassName("hint-776");
// MAGIC     var answer = document.getElementById("answer-776");
...
// MAGIC     }
// MAGIC 
// MAGIC     var button = document.getElementById("hint-button-776");
...
// MAGIC           id="hint-button-776">Click here for a hint</button>
// MAGIC </div>
// MAGIC <div id="answer-776" style="padding-bottom: 20px; display: none">
// MAGIC   The answer:
...
// MAGIC <script type="text/javascript">
// MAGIC   window.onload = function() {
// MAGIC     var allHints = document.getElementsByClassName("hint-8026");
// MAGIC     var answer = document.getElementById("answer-8026");
// MAGIC     var totalHints = allHints.length;
// MAGIC     var nextHint = 0;
// MAGIC     var hasAnswer = (answer != null);
// MAGIC     var items = new Array();
...
// MAGIC     }
// MAGIC 
// MAGIC     var button = document.getElementById("hint-button-8026");
// MAGIC     if (totalHints == 0) {
// MAGIC       button.innerHTML = answerLabel;
// MAGIC     }
// MAGIC     button.onclick = function() {
...
// MAGIC   <button type="button" class="btn btn-light"
// MAGIC           style="margin-top: 1em"
// MAGIC           id="hint-button-8026">Click here for a hint</button>
// MAGIC </div>
// MAGIC <div id="answer-8026" style="padding-bottom: 20px; display: none">
// MAGIC   The answer:
// MAGIC   <div class="answer" style="margin-left: 1em">
...
// MAGIC <script type="text/javascript">
// MAGIC   window.onload = function() {
// MAGIC     var allHints = document.getElementsByClassName("hint-1557");
// MAGIC     var answer = document.getElementById("answer-1557");
// MAGIC     var totalHints = allHints.length;
// MAGIC     var nextHint = 0;
// MAGIC     var hasAnswer = (answer != null);
// MAGIC     var items = new Array();
...
// MAGIC     }
// MAGIC 
// MAGIC     var button = document.getElementById("hint-button-1557");
// MAGIC     if (totalHints == 0) {
// MAGIC       button.innerHTML = answerLabel;
// MAGIC     }
// MAGIC     button.onclick = function() {
...
// MAGIC   <button type="button" class="btn btn-light"
// MAGIC           style="margin-top: 1em"
// MAGIC           id="hint-button-1557">Click here for a hint</button>
// MAGIC </div>
// MAGIC <div id="answer-1557" style="padding-bottom: 20px; display: none">
// MAGIC   The answer:
// MAGIC   <div class="answer" style="margin-left: 1em">
...
// MAGIC <script type="text/javascript">
// MAGIC   window.onload = function() {
// MAGIC     var allHints = document.getElementsByClassName("hint-6848");
// MAGIC     var answer = document.getElementById("answer-6848");
// MAGIC     var totalHints = allHints.length;
// MAGIC     var nextHint = 0;
// MAGIC     var hasAnswer = (answer != null);
// MAGIC     var items = new Array();
...
// MAGIC     }
// MAGIC 
// MAGIC     var button = document.getElementById("hint-button-6848");
// MAGIC     if (totalHints == 0) {
// MAGIC       button.innerHTML = answerLabel;
// MAGIC     }
// MAGIC     button.onclick = function() {
...
// MAGIC   <button type="button" class="btn btn-light"
// MAGIC           style="margin-top: 1em"
// MAGIC           id="hint-button-6848">Click here for a hint</button>
// MAGIC </div>
// MAGIC <div id="answer-6848" style="padding-bottom: 20px; display: none">
// MAGIC   The answer:
// MAGIC   <div class="answer" style="margin-left: 1em">
...
// MAGIC <script type="text/javascript">
// MAGIC   window.onload = function() {
// MAGIC     var allHints = document.getElementsByClassName("hint-1633");
// MAGIC     var answer = document.getElementById("answer-1633");
// MAGIC     var totalHints = allHints.length;
// MAGIC     var nextHint = 0;
// MAGIC     var hasAnswer = (answer != null);
// MAGIC     var items = new Array();
...
// MAGIC     }
// MAGIC 
// MAGIC     var button = document.getElementById("hint-button-1633");
// MAGIC     if (totalHints == 0) {
// MAGIC       button.innerHTML = answerLabel;
// MAGIC     }
// MAGIC     button.onclick = function() {
...
// MAGIC   <button type="button" class="btn btn-light"
// MAGIC           style="margin-top: 1em"
// MAGIC           id="hint-button-1633">Click here for a hint</button>
// MAGIC </div>
// MAGIC <div id="answer-1633" style="padding-bottom: 20px; display: none">
// MAGIC   The answer:
// MAGIC   <div class="answer" style="margin-left: 1em">
